...
%make_empty_dataset(metadatafile=C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/SDTM_METADATA.xlsx,dataset=DM);
%put &DMkeepSTRING;
...
%make_sort_order(metadatafile=C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/SDTM_METADATA.xlsx,dataset=DM);
%put &DMSORTSTRING;
/*STUDYID  USUBJID ???*/
...
%make_empty_dataset(metadatafile=C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/SDTM_METADATA.xlsx,dataset=SUPPDM);
...
%make_sort_order(metadatafile=C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/SDTM_METADATA.xlsx,dataset=SUPPDM);
...
proc contents data= target.suppdm varnum;
run;
proc contents data= target.dm varnum;
run;

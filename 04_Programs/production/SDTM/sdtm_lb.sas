...
%make_empty_dataset(metadatafile=C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/SDTM_METADATA.xlsx,dataset=LB);
...
%make_sort_order(metadatafile=C:\Users\hed2\Downloads\sas practice\SAS-Clinical-Trials-Toolkit-master2\SAS-Clinical-Trials-Toolkit-master/SDTM_METADATA.xlsx,dataset=LB);
...
proc contents data= target.lb varnum;
run;
